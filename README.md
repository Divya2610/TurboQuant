...
### Single-Model CPU Benchmark (E2B)
```bash
python benchmark.py \
...
### Single-Model CPU Benchmark (E4B)
```bash
python benchmark_gemma4_e4b_cpu.py \
    --model /path/to/gemma-4-E4B \
    --runs 3 \
    --key-bits 3 \
    --val-bits 2
```

### Single-Model GPU Benchmark (E2B)
```bash
python benchmark_script_gemma2b_gpu.py \
    --model ./google-gemma-4-E2B \
    --runs 3 \
    --key-bits 3 \
    --val-bits 3
...
### Single-Model GPU Benchmark (E4B)
```bash
python benchmark_gemma4_e4b_gpu.py \
    --model /path/to/gemma-4-E4B \
    --runs 3 \
    --key-bits 3 \
    --val-bits 3
...
### Side-by-Side CPU Comparison
```bash
python comparative_analysis_cpu.py \
    --e2b-model ./google-gemma-4-E2B \
    --e4b-model /path/to/gemma-4-E4B \
    --runs 3 \
    --key-bits 3 \
    --val-bits 2
```

### Side-by-Side GPU Comparison
```bash
python benchmark_compare_gpu.py \
    --model-e2b ./google-gemma-4-E2B \
    --model-e4b /path/to/gemma-4-E4B \
    --runs 3 \
    --key-bits 3 \
    --val-bits 2
```
